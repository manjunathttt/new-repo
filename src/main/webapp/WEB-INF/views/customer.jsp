		...
		<form:form role="customer" commandName="customer" action="${addAction}">
            ...
            <div class="form-group">
            	<c:if test="${customer.cid > 0}">
					<input type="submit" class="btn btn-primary" value="<spring:message text="Edit Customer"/>" />
				</c:if>
				<c:if test="${customer.cid == 0}">
					<input type="submit" class="btn btn-primary" value="<spring:message text="Add Customer"/>" />
				</c:if>
			</div>
       		...
       		<div class="container">
				<!-- Angular script -->
					...
					<table class="table table-striped table-hover">
						<thead>
							<tr>
								<th ng-click="sort('cid')">CUSTOMER ID 
									<span class="glyphicon sort-icon" ng-show="sortKey=='cid'"
									ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
								</th>
						
								<th ng-click="sort('cname')">CUSTOMER NAME 
									<span class="glyphicon sort-icon" ng-show="sortKey=='cname'"
									ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
								</th>
						
								<th ng-click="sort('caddress')">CUSTOMER ADDRESS 
									<span class="glyphicon sort-icon" ng-show="sortKey=='caddress'"
									ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
								</th>
						
								<th ng-click="sort('cphone')">CUSTOMER PHONE NO 
									<span class="glyphicon sort-icon" ng-show="sortKey=='cphone'"
									ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
								</th>
